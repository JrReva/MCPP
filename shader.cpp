...
void Shader::UpdateIntUniform(const std::string& name, GLint value) const
{
    glUniform1i(glGetUniformLocation(m_program, name.c_str()), value);
}

void Shader::UpdateFloatUniform(const std::string& name, GLfloat value) const
{
    glUniform1f(glGetUniformLocation(m_program, name.c_str()), value);
}


void Shader::UpdateVec4Uniform(const std::string& name, GLfloat x, GLfloat y , GLfloat z, GLfloat w) const
{
