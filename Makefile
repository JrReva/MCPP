...
LINKER_FLAGS = -lm -L/usr/X11R6/lib -L/usr/local/lib -Lexternal/sfml16_linux64/lib -lGL -lGLU -lpthread -lsndfile -lsfml-system-s -lopenal -lsfml-audio-s -lsfml-graphics-s -lsfml-window-s -lsfml-system-s -lXrandr -lIL -lILU -lX11
